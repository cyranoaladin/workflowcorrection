...
def integrations_status() -> dict:
    ...
    return {
        "mathpix": {"configured": bool(settings.MATHPIX_APP_ID and settings.MATHPIX_APP_KEY), "paid_calls_enabled": paid},
        ...
        "openai": {"configured": bool(settings.OPENAI_API_KEY), "paid_calls_enabled": paid},
        "ocr": {
            "paid_calls_enabled": paid,
